...
HELP_LINES = [
    ...
    ("help", "  Start with --groups to manage groups without opening a contact session"),
    ("help", "  Start with --group <group> to open one dedicated group chat"),
    ...
    ("help_bold", "Messaging:"),
    ("help", ""),
    ("help", "  Command line: ENTER executes commands only"),
    ("help", "  Message panel: ENTER inserts newline; Alt+S or F5 sends"),
    ...
    ("help_bold", "Groups:"),
    ("help", ""),
    ("help", "  /admin                   Open group admin modal when no group is open"),
    ("help", "  /group                   Open active group modal when group chat is open"),
    ("help", "  /disconnect              Close current group chat"),
    ("help", ""),
    ("help_bold", "Utility:"),
    ("help", ""),
    ("help", "  c                        Copy selected bubble text"),
    ("help", "  r                        Reply to selected bubble"),
    ("help", "  /copyaddr                Copy local b32 address"),
    ("help", "  /profiles, /contacts     Show persistent accounts"),
